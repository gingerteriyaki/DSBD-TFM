...
archivo = os.environ.get('PRODUCCION_DATA_PATH', 'file-KUHNjBu92SZrHmASg0YcAcqj.xls')
...
output_path = os.environ.get('PROCESSED_PRODUCCION_DATA_PATH', 'datos_produccion_mensuales.xlsx')
datos_df.to_excel(output_path, index=False)

print(f"Datos de producción preprocesados y guardados en {output_path}")
